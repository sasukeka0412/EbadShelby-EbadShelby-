...
```aura width=860 height=140 link="https://collectioneur.github.io/readme-aura/"
(function() {
  var stats = [
      ...
      {stats.map(function(s, i) {
        return (
          <div key={s.label} style={{
            ...
            padding: '16px 4px', zIndex: 10,
            borderRight: i < stats.length - 1 ? '1px solid rgba(255,255,255,0.06)' : 'none',
            gap: 5,
          }}>
            <div style={{ display:'flex', fontSize:28, fontWeight:800, color:s.color, lineHeight:1 }}>
              {s.value}
            </div>
            <div style={{ display:'flex', fontSize:10, color:'rgba(200,195,225,0.45)', fontWeight:600, letterSpacing:'1px', textAlign:'center' }}>
              {s.label.toUpperCase()}
            </div>
          </div>
        );
...
(function() {
  var categories = [
    { title: 'Frontend', color: '#60a5fa', items: ['HTML', 'CSS', 'JavaScript', 'Tailwind', 'Vue.js', 'TypeScript'] },
    { title: 'Backend', color: '#a78bfa', items: ['PHP', 'MySQL', 'Laravel'] },
    { title: 'Design', color: '#f472b6', items: ['Figma', 'Affinity', 'Excalidraw'] },
    { title: 'Tools', color: '#34d399', items: ['Git', 'GitHub', 'VS Code', 'Antigravity'] },
    { title: 'OS', color: '#fbbf24', items: ['Fedora Linux', 'Windows'] },
  ];
  ...
  return (
    <div style={{
      ...
      <div style={{ display:'flex', fontSize:10, fontWeight:700, color:'rgba(155,140,210,0.5)', letterSpacing:'3px', zIndex: 10 }}>
        TECH STACK
      </div>
